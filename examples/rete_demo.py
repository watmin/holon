...
class ReteDemo:
    ...
    def run_forward_chaining(self, max_iterations=3):
        ...
        for iteration in range(max_iterations):
            ...
            for rule in self.rules:
                ...
                results = self.client.search_json(probe=rule["conditions"], limit=10)
    ...
    def query_derived(self, query):
        ...
        results = self.client.search_json(probe=query, guard=guard, limit=10)
    ...
    def grandparent_rule(fact):
        ...
        if fact.get("has_children") and "person" in fact:
            ...
            grandparents = demo.client.search_json(
                probe={"parent_of": fact["person"], "has_children": True}, limit=5
            )
            if grandparents:
                return {
                    "person": fact["person"],
