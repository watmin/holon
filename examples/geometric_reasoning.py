...
def main():
    ...
    results = client.search_json(probe=probe_data, limit=3)
    ...
    results = client.search_json(probe=probe_xor, limit=3)
    ...
    results = client.search_json(probe=prog_probe, limit=5)
    ...
    results = client.search_json(probe=novel_probe, limit=3)
