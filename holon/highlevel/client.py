...
if TYPE_CHECKING:
    from ..kernel.store import CPUStore
    from ..memory.engram import EngramLibrary
    from ..memory.subspace import OnlineSubspace
    ...
    **Similarity**:
    ...
    def encode_vectors(
        ...
        if self._mode == "http":
            ...
            from ..kernel.utils.atomizer import parse_data
    ...
    def encode_mathematical(
        ...
        if self._mode == "http":
            ...
            from ..kernel.encoder import MathematicalPrimitive
