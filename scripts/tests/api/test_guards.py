...
if __name__ == "__main__":
    ...
    # Query without guard
    probe = {"user": "alice"}
    results = client.search_json(probe, limit=10)
    ...
    results_guarded = client.search_json(probe, limit=10, guard=success_guard)
    ...
    results_login = client.search_json(probe, limit=10, guard=login_guard)
