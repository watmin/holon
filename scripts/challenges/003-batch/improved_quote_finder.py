...
class ImprovedQuoteLocator:
                ...
                # Check for fuzzy matches
                    ...
                    if similarity >= min_similarity:
                        ...
                        best_match = self._find_best_substring_match(
                            quote_lower, chunk_text_lower, similarity
                        )
    ...
    def _find_best_substring_match(
        self, quote: str, text: str, min_similarity: float
    ) -> str:
...
class IntelligentQuoteFinder:
    ...
    def ingest_pdf_content(self, pdf_index_file: str) -> bool:
        ...
        try:
            ...
            print(
                f"✅ Successfully loaded PDF content with {len(indexed_chunks)} chunks"
            )
            return True
    ...
    def find_quote(
        self, quote_text: str, search_strategy: str = "intelligent"
    ) -> Dict[str, Any]:
        """
        ...
        if search_strategy == "intelligent":
            locations = self.locator.find_quote_locations(
                quote_text, min_similarity=0.7
            )
    ...
    def _create_chunk_unit(self, chunk: Dict[str, Any]) -> Dict[str, Any]:
        ...
        unit = {
            "text": {"_encode_mode": "ngram", "sequence": words},
            "coordinates": chunk["coordinates"],
            "metadata": {
                "chunk_id": chunk["id"],
    ...
    def _generate_recommendations(
        ...
        if not locations:
            return [
                "No quote locations found. Try different wording or check spelling."
            ]
...
def demonstrate_intelligent_quote_finding():
    ...
    test_quotes = [
        ...
        {"text": "differential calculus", "description": "Technical term"},
        {"text": "slope of the tangent", "description": "Mathematical concept"},
    ]
